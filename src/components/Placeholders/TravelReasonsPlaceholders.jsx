...
const TravelReasonDetailsPlaceholder = props => (
  <div style={{marginTop: -52 + 'px', paddingTop: -55 + 'px'}}>
    <ContentLoader
      height={550} width={1080} peed={1.5}
      primaryColor="#dfdfdf" secondaryColor="#ffffff"
      {...props}
    >
...
export default TravelReasonDetailsPlaceholder;
