...
const TravelReadinessPlaceholder = props => (
  <ContentLoader
    height={250}
    width={500}
    speed={1.5}
  ...
  >
    ...
    <rect x="183.63" y="52.74" rx="0" ry="0" width="112.91" height="9.79" />
    <rect x="374.17" y="51.06" rx="0" ry="0" width="180.86" height="10.43" />
    <rect x="3.63" y="89.61" rx="0" ry="0" width="530" height="171" />

  </ContentLoader>
);

export default TravelReadinessPlaceholder;
