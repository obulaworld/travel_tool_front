...
export default class TimelineDropdownCalendar extends PureComponent {
  static defaultProps = {
    icon: '',
    defaultSelected: '',
  }
  ...
  render() {
    ...
    return (
      <Fragment>
        <button type="button" className="action-btn--calender" onClick={this.showDropdownItems}>
          {selectedItem}
...
TimelineDropdownCalendar.propTypes = {
