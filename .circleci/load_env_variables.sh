...
if [ "$CIRCLE_BRANCH" == 'master' ]; then
    ...
    REACT_APP_ALL_USERS=$PRODUCTION_ALL_USERS
    REACT_APP_DEFAULT_LOCATION=$PRODUCTION_DEFAULT_LOCATION
    REACT_APP_BUGSNAG_API_KEY=$PRODUCTION_BUGSNAG_API_KEY
    REACT_APP_JWT_PUBLIC_KEY=$PRODUCTION_JWT_PUBLIC_KEY
else
    ...
    REACT_APP_ALL_USERS=$STAGING_ALL_USERS
    REACT_APP_DEFAULT_LOCATION=$STAGING_DEFAULT_LOCATION
    REACT_APP_BUGSNAG_API_KEY=$STAGING_BUGSNAG_API_KEY
    REACT_APP_JWT_PUBLIC_KEY=$STAGING_JWT_PUBLIC_KEY
fi
