...
require PRODUCTION_REACT_APP_CLOUNDINARY_API $PRODUCTION_REACT_APP_CLOUNDINARY_API
require PRODUCTION_REACT_APP_PRESET_NAME $PRODUCTION_REACT_APP_PRESET_NAME
...
require STAGING_REACT_APP_CLOUNDINARY_API $STAGING_REACT_APP_CLOUNDINARY_API
require STAGING_REACT_APP_PRESET_NAME $STAGING_REACT_APP_PRESET_NAME
...
if [ "$CIRCLE_BRANCH" == 'master' ]; then
    ...
    REACT_APP_CLOUNDINARY_API=$PRODUCTION_REACT_APP_CLOUNDINARY_API
    REACT_APP_PRESET_NAME=$PRODUCTION_REACT_APP_PRESET_NAME
else
    ...
    REACT_APP_CLOUNDINARY_API=$STAGING_REACT_APP_CLOUNDINARY_API
    REACT_APP_PRESET_NAME=$STAGING_REACT_APP_PRESET_NAME
fi
